...
cMoveTo_AB_Time::cMoveTo_AB_Time(cGameObject* pGO, glm::vec3 startPosition, glm::vec3 endPosition, float TimeToMove, float easeIn, float easeOut)
{
...
cMoveTo_AB_Time::cMoveTo_AB_Time(std::string name, std::string type, cGameObject* pGO, glm::vec3 startPosition, glm::vec3 endPosition, float TimeToMove, float easeIn, float easeOut)
{
	this->m_startPosition = startPosition;
	this->m_endPosition = endPosition;
	this->m_TimeToMove = TimeToMove;
...
{
	float distance = glm::distance( this->m_pTheGO->positionXYZ, this->m_startPosition );
