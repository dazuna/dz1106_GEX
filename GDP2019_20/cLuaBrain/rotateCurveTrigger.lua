...
MoveTo("mvShp","move","tie1",     50, 0, 0,     40.0, 0.0, 0.0,    5,1,1)
Rotate("rtTie","rott","tie1",    0,30,0,    5,1,1)
Curve("crvTie1","curv","tie1",    40,0,0,    40,10,50,    60,5,20,    8,2,2)
Rotate("rtTie2","rott","tie1",    0,-80,0,    8,1,1)

Follow("fllSph6","foll","sphere6","tie1",15,    0,1,0,   10,1,5)
Trigger("shipTrigger","trigg","tie1",    60,5,20,    "fllSph6",11,15)
MoveTo("mvShp2","move","tie1",     40,10,50,     -2000.0, 0.0, 2000.0,    5,3,1)
...
addToSerial("mvShp","shipNavigation")
addToSerial("rtTie","shipNavigation")
addToParallel("shipTrigger","follSphere")
